...
if(isset($_SESSION['id'])) {
    ...
    $stat2 = "select * from skills where user_id= $_SESSION[id]  ";
...
<body>
    ...
    if(isset($_SESSION['success'])) {
       /* echo '<div id="successMessage" style="display: block; color: green;">';
        echo $_SESSION['success'];
        echo '<button onclick="hideMessage()">Close</button>';
        echo '</div>';*/
...
?>
    ...
    <main>
            ...
            <div class="container custom-container">
                <div class="row align-items-center justify-content-center justify-content-lg-between">
                    <div class="col-lg-6 order-0 order-lg-2">
                        ...
                        <?php if(isset($_SESSION['id'])){
                                     $stat2 = "select * from users ";
                                     $quer = mysqli_query($conn, $stat2);
        ...
        <section id="aboutSection" class="about">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <?php  while($row = mysqli_fetch_assoc($query2)  ) :
                        ...
                        ?>
                             <li>
                  <img class="light" src="assets/img/icons/<?=$row['skill_img']?>" alt="">
                                </li>
                        <?php endif;
                              endwhile;?>
                        </ul>
          ...
          <a href="cv.php?id=<?=$_SESSION['id']?>" class="btn">Download my resume</a>
          <?php// endwhile;?>
                        </div>
                    </div>
                </div>
        ...
        <section class="services">
            <div class="container">
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-xl-5 col-lg-6 col-md-8">
                            <div class="section__title">
                                ...
                                <div class="header__btn d-none d-md-block">
                                    <?php if(isset($_SESSION['id'])){?>
                        <a href="serv.php?id=<?=$_SESSION['id']?>" class="btn">Add Service</a>
                ...
                <div class="row gx-0 services__active">
                                    ...
                                    <?php
$ser="select * from services where user_id=$_SESSION[id]";
$quer = mysqli_query($conn, $ser);
while($serv = mysqli_fetch_assoc($quer)):
...
<div class="col-xl-3">
   ...
   <div class="services__icon">
          <img class="light" src="assets/img/serv/<?=$serv['ser_img']?>" alt="">
                    <img class="dark" src="assets/img/icons/services_icon01.png" alt="">
                                    </div>  
                                <h3 class="title"><a href="services-details.html"><?=$serv['ser_name']?></a></h3>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="homeContact__content">
                                ...
                                <h2 class=""><a href="">leave a message</a></h2>
                        ...
                        <div class="col-lg-6">
                            ...
                            <h2 class="mail"><a href="mailto:Info@webmail.com">Add skill or resume</a></h2>
...
?>
                                    <input type="text" name="skilln" placeholder="Enter skill name*">
                                    <label>Enter skill icon</label>
                                    <input type="file"  name ="simage" placeholder="Enter mail*">
                                    <label>Enter resume file</label>

                                    <input type="file" name="cv" placeholder="Enter number*"><br>
...
?>
                      ...
                      <input type="" id="num" placeholder="Enter phone*">
                    <textarea id="mseg" placeholder="Enter Message*"></textarea>
...
function addmsg(e){
  ...
  var ms=document.getElementById('mseg').value;
